...
This node is just a temporary fix to make the plugin work with Todoist API v2. The node is functional and superimposable on the original plugin: there is therefore no need to uninstall the foxleigh81 one, waiting for it to be updated
